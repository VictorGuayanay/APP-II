...
- Actualización del Product Backlog_V3 con criterios nuevos obtenidos
- Sprint 3 - 4 -5 realizados con una deuda técnica ademas de validación de gestión de usuarios
- Actualización del documento de requisitos despues de reunión
- Actualización del Product Backlog_V4 con nuevos requerimientos
- Sprint 6 - 7 pagado deuda técnica ademas de implementación de funcionalidades nuevas
- Sprint 8 realizado ademas de adelantar reportes
- Sprint 9 Generación de reportes y Comprobantes de Pago
- Sprint 10 último sprint realizado, revisar funcionalidades que aun falta funcionar
- Finalización del proyecto con las funcionalidades especificados en los docuementos  