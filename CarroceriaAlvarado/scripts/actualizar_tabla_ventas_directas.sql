-- Script para actualizar tabla de Ventas Directas y crear tabla de detalles
-- Base de datos: CarroceriaAlvaradoDB

USE CarroceriaAlvaradoDB;
GO

-- Primero, eliminar la tabla anterior si existe (solo para desarrollo)
-- COMENTAR ESTAS LÍNEAS EN PRODUCCIÓN
IF OBJECT_ID('Ventas_Directas', 'U') IS NOT NULL
    DROP TABLE Ventas_Directas;
GO

-- Crear tabla Ventas_Directas actualizada
...
PRINT 'Tablas de ventas creadas/actualizadas exitosamente';
GO
